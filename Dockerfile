...
RUN stack --no-terminal install --haddock accelerate-llvm-native ad Agda apply-refact atom-conduit bound cabal-install compact criterion dhall diagrams-svg distributed-closure distributed-process-simplelocalnet distributed-process-tests doctest ekg ersatz feed ghcid gloss GPipe haxl hedgehog-quickcheck hlint hoogle hpack hworker intero irc-client katip-elasticsearch lmdb megaparsec morte pandoc pcre-heavy picosat pretty-show repa-algorithms repa-io SafeSemaphore sbv sdl2 selda-postgresql selda-sqlite servant-client servant-swagger-ui servant-websockets singletons stm-containers stylish-haskell tasty-quickcheck tasty-smallcheck TCache threepenny-gui transient-universe unagi-chan unbound-generics vcswrapper zeromq4-haskell zippers
